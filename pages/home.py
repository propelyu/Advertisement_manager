...
<<<<<<< HEAD
    ...
    with ui.element("section").style(
        ...
        ui.label("WELCOME TO PROPEL PROPERTIES").classes(
            ...
            "color: gold; text-shadow: 0 0 10px #FFD700, 0 0 20px #FFA500, 0 0 30px #FF8C00;"
        )
        ui.label("Find your dream property today").classes(
    ...
    with ui.element("section").classes("w-full py-16"):
        with ui.element("div").classes("mx-auto max-w-7xl w-full px-6 "):
            ui.label("Featured Properties").classes(
            ...
            with ui.row().classes("w-full justify-center gap-8 flex-wrap"):
                for idx, prop in enumerate(properties):
                    with ui.card().classes(
                        ...
                        card.on(
                            "click",
                            lambda i=prop["id"]: ui.navigate.to(f"/view_event?id={i}"),
                        )
                        ...
                        with ui.element("div").classes("p- text-left"):
                            ...
                            with ui.row().classes(
                                ...
                                ui.label(f"GHS {prop['price']}").classes(
                                    "text-lg text-green-600 font-semibold text-left"
                                )
    ui.button("View All Properties").on("click", lambda: ui.navigate.to("/all_adverts"))
=======
    #  HERO SECTION 
